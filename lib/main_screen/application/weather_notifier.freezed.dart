...
class __$$_DoneCopyWithImpl<$Res>
    extends _$WeatherStateCopyWithImpl<$Res, _$_Done>
...
class _$_Done extends _Done {
  const _$_Done(this.weather) : super._();
...
abstract class _Done extends WeatherState {
  const factory _Done(final Weather weather) = _$_Done;
...
class _$_Failed extends _Failed {
  const _$_Failed(this.errorMessage) : super._();
...
abstract class _Failed extends WeatherState {
  const factory _Failed(final String errorMessage) = _$_Failed;
